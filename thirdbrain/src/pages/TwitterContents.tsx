...
const TwitterContents = () => {
    ...
    const filteredContents = contents && contents.length > 0 && contents.filter((f) => f.type !== 'youtube' && f.userId.username ===  user.username)
  return (
    <div className="">
    {isLoading && (
    ...
    <div className="flex flex-wrap gap-5">
      { filteredContents.length === 0 ? <h1 className='text-2xl font-semibold'>No Content Available related to twitter</h1> :
