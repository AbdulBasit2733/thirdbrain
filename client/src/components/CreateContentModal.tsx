...
const CreateContentModal = ({ open, onClose }) => {
  ...
  const handleCreateContent = async () => {
    ...
    console.log(title, link, tagTitle);
  };
  return (
    <>
      {open && (
        <div className="backdrop-brightness-50 h-screen w-screen fixed top-0 left-0 flex justify-center items-center">
          <div className={`${open ? "w-96 transition-all ease-out duration-1000 bg-white flex flex-col justify-center rounded-md shadow-2xl" : "w-0 transition-all duration-1000"}`}>
